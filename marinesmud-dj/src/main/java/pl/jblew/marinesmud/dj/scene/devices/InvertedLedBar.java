 ...
 * @author teofil
 */
public class InvertedLedBar extends DMXDevice implements RGBDevice {
    public String name;
    public int address;
    public int min = 0;
    public int max = 255;
    public float gammaR = 1f;
    public float gammaG = 1f;
    public float gammaB = 1f;
    ...
    public InvertedLedBar(String name, int address) {
        this.name = name;
        this.address = address;
    }

    public InvertedLedBar() {
    ...
    public byte[] calculateLevels() {
        synchronized (sync) {
            return new byte[]{(byte) ((1f - levels[0]*gammaR) * 255f), (byte) ((1f - levels[1]*gammaG) * 255f), (byte) ((1f-levels[2]*gammaB) * 255f)};
        }
    }
