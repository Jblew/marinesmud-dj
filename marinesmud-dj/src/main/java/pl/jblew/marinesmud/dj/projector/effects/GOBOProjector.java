 ...
 * @author teofil
 */
public class GOBOProjector extends Projector {
    private final GOBOLoader goboLoader;
    private final GradientHue gradientHue;
    private final Object sync = new Object();
    private final GOBOLoader.GoboSelector selectedGobo;
    ...
    public GOBOProjector(GOBOLoader.GoboSelector gobo) {
        this.selectedGobo = gobo;
        this.goboLoader = new GOBOLoader(gobo);
    ...
    public String getURIName() {
        return "GOBO"+this.selectedGobo.name();
    }
