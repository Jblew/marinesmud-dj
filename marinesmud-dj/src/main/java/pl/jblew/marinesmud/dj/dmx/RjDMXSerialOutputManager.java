 ...
 * @author teofil
 */
public class RjDMXSerialOutputManager implements OutputManager {
    ...
    public RjDMXSerialOutputManager(ClockWorker clock, Scene scene) {
        this.clock = clock;
        this.scene = scene;
    ...
    private void write(SerialPort port, byte[] channelValues) throws InterruptedException, IOException {
        ...
        TimeUnit.MICROSECONDS.sleep(1700);
